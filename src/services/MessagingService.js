...
class MessagingService {
  async send(params) {
    ...
    if (channel === "whatsapp") {
      return await WhatsAppService.sendMessage(sender, receiver, type, content, metadata);
    } else if (channel === "rcs") {
      return await RCSService.sendMessage(sender, receiver, type, content, metadata);
    } else {
